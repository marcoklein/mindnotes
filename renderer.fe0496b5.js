...
},{}],"core/events/EventTypes.ts":[function(require,module,exports) {
"use strict";
...
},{"d3":"../node_modules/d3/index.js","./GraphNode":"renderer/graph/GraphNode.ts","./GraphData":"renderer/graph/GraphData.ts"}],"renderer/EventRenderer.ts":[function(require,module,exports) {
"use strict";
...
},{"./graph/MindmapView":"renderer/graph/MindmapView.ts","../core/events/EventTypes":"core/events/EventTypes.ts"}],"renderer/index.ts":[function(require,module,exports) {
"use strict";
...
(function () {
  ...
  var renderer = new EventRenderer_1.EventRenderer(emitter);
...
function testRenderer(emitter) {
  emitter.emit(new EventTypes_1.AddNodeEvent(1, undefined, 'root'));
  emitter.emit(new EventTypes_1.AddNodeEvent(2, 1, 'parent'));
  emitter.emit(new EventTypes_1.AddNodeEvent(3, 2, 'childA'));
  emitter.emit(new EventTypes_1.AddNodeEvent(4, 2, 'childB'));
  emitter.emit(new EventTypes_1.AddNodeEvent(5, 1, 'sibling'));
  emitter.emit(new EventTypes_1.EditNodeEvent(2, undefined, 'parent edit'));
}
},{"../core/events/EventHandler":"core/events/EventHandler.ts","../core/events/EventTypes":"core/events/EventTypes.ts","./EventRenderer":"renderer/EventRenderer.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","renderer/index.ts"], null)
//# sourceMappingURL=/renderer.fe0496b5.js.map