parcelRequire=function(e,r,t,n){var i,o="function"==typeof parcelRequire&&parcelRequire,u="function"==typeof require&&require;function f(t,n){if(!r[t]){if(!e[t]){var i="function"==typeof parcelRequire&&parcelRequire;if(!n&&i)return i(t,!0);if(o)return o(t,!0);if(u&&"string"==typeof t)return u(t);var c=new Error("Cannot find module '"+t+"'");throw c.code="MODULE_NOT_FOUND",c}p.resolve=function(r){return e[t][1][r]||r},p.cache={};var l=r[t]=new f.Module(t);e[t][0].call(l.exports,p,l,l.exports,this)}return r[t].exports;function p(e){return f(p.resolve(e))}}f.isParcelRequire=!0,f.Module=function(e){this.id=e,this.bundle=f,this.exports={}},f.modules=e,f.cache=r,f.parent=o,f.register=function(r,t){e[r]=[function(e,r){r.exports=t},{}]};for(var c=0;c<t.length;c++)try{f(t[c])}catch(e){i||(i=e)}if(t.length){var l=f(t[t.length-1]);"object"==typeof exports&&"undefined"!=typeof module?module.exports=l:"function"==typeof define&&define.amd?define(function(){return l}):n&&(this[n]=l)}if(parcelRequire=f,i)throw i;return f}({"EUAH":[function(require,module,exports) {
"use strict";function e(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}function n(e,n){for(var t=0;t<n.length;t++){var r=n[t];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function t(e,t,r){return t&&n(e.prototype,t),r&&n(e,r),e}Object.defineProperty(exports,"__esModule",{value:!0});var r=function(){function n(){e(this,n),this.handlers={}}return t(n,[{key:"registerHandler",value:function(e,n){this.handlers[e]=n}},{key:"handleSerializedEvent",value:function(e){var n=JSON.parse(e);this.emit(n)}},{key:"emit",value:function(e){var n=this.handlers[e.name];console.log("SerializedEventEmitter: emitting event",e,n),n&&n(e)}}]),n}();exports.SerializedEventEmitter=r;
...
},{"./adder.js":"fG8A","./math.js":"JQgf","./noop.js":"zOhu","./stream.js":"XQuq"}],"V83Q":[function(require,module,exports) {
...
},{"./math.js":"JQgf","./noop.js":"zOhu","./stream.js":"XQuq"}],"tY9i":[function(require,module,exports) {
...
},{"./adder.js":"fG8A","./math.js":"JQgf","./noop.js":"zOhu","./stream.js":"XQuq"}],"hTgK":[function(require,module,exports) {
...
},{"../adder.js":"fG8A","../math.js":"JQgf","../noop.js":"zOhu"}],"tL3W":[function(require,module,exports) {
...
},{"../adder.js":"fG8A","../math.js":"JQgf","../noop.js":"zOhu"}],"cxj1":[function(require,module,exports) {
...
},{"./dist/package.js":"pT13","d3-array":"K0bd","d3-axis":"mp0m","d3-brush":"tkh5","d3-chord":"Iy8J","d3-collection":"S3hn","d3-color":"Peej","d3-contour":"SiBy","d3-dispatch":"D3zY","d3-drag":"kkdU","d3-dsv":"EC2w","d3-ease":"pJ11","d3-fetch":"grWT","d3-force":"oYRE","d3-format":"VuZR","d3-geo":"Ah6W","d3-hierarchy":"Kps6","d3-interpolate":"k9aH","d3-path":"OTyq","d3-polygon":"H15P","d3-quadtree":"lUbg","d3-random":"Gz2j","d3-scale":"zL2z","d3-scale-chromatic":"ado2","d3-selection":"ysDv","d3-shape":"maww","d3-time":"hQYG","d3-time-format":"UYpZ","d3-timer":"rdzS","d3-transition":"UqVV","d3-voronoi":"rLIC","d3-zoom":"MHdZ"}],"aEd8":[function(require,module,exports) {
"use strict";function t(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function e(t,e){for(var r=0;r<e.length;r++){var a=e[r];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(t,a.key,a)}}function r(t,r,a){return r&&e(t.prototype,r),a&&e(t,a),t}Object.defineProperty(exports,"__esModule",{value:!0});var a=function(){function e(r,a,i){t(this,e),this.graphData=r,this.source=a,this.target=i,this.id=this.source.id+"-"+this.target.id}return r(e,[{key:"remove",value:function(){delete this.graphData.linksMap[this.id],this.graphData.mindmap.renderLinks(),this.graphData.markAsDirty()}}]),e}();exports.GraphLinkData=a;
},{}],"moJA":[function(require,module,exports) {
"use strict";function t(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function e(t,e){for(var a=0;a<e.length;a++){var i=e[a];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}function a(t,a,i){return a&&e(t.prototype,a),i&&e(t,i),t}Object.defineProperty(exports,"__esModule",{value:!0});var i=require("./GraphLink"),r=function(){function e(a,i,r){t(this,e),this.textLines=[],this.graphData=a,this.id=i,this.textLines=[r],this.x=0,this.y=0}return a(e,[{key:"getText",value:function(){return this.textLines.join("\n")}},{key:"changeParent",value:function(t){if(this._parentId===t)return this;this._parentId&&this.graphData.getLinkFromNodeIds(this.id,this._parentId).remove();var e=this.graphData.mindmap.getNode(t);if(e){var a=new i.GraphLinkData(this.graphData,this,e);this._parentId=t,this.graphData.pushLink(a),this.graphData.mindmap.renderLinks(),this.graphData.markAsDirty()}return this}},{key:"changeText",value:function(t,e){this.textLines[e]=t,this.graphData.mindmap.renderNodes(),this.graphData.markAsDirty()}},{key:"remove",value:function(){console.log("Removing node with id "+this.id),this._parentId&&this.graphData.getLinkFromNodeIds(this.id,this._parentId).remove(),delete this.graphData.nodesMap[this.id],this.graphData.mindmap.renderNodes(),this.graphData.markAsDirty()}}]),e}();exports.GraphNode=r;
},{"./GraphLink":"aEd8"}],"dL8o":[function(require,module,exports) {
"use strict";function e(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}function n(e,n){for(var t=0;t<n.length;t++){var i=n[t];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}function t(e,t,i){return t&&n(e.prototype,t),i&&n(e,i),e}Object.defineProperty(exports,"__esModule",{value:!0});var i=function(){function n(t){e(this,n),this.nodesMap={},this.linksMap={},this.mindmap=t}return t(n,[{key:"pushNode",value:function(e){console.log("Pushed node ",e),this.nodesMap[e.id]=e}},{key:"pushLink",value:function(e){console.log("Pushed link ",e),this.linksMap[e.id]=e}},{key:"getNodes",value:function(){return Object.values(this.nodesMap)}},{key:"getLinks",value:function(){return Object.values(this.linksMap)}},{key:"getLinkFromNodeIds",value:function(e,n){return this.linksMap[e+"-"+n]}},{key:"markAsDirty",value:function(){this.mindmap.restartSimulation()}}]),n}();exports.GraphData=i;
},{}],"hS4r":[function(require,module,exports) {
"use strict";function t(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function e(t,e){for(var n=0;n<e.length;n++){var r=e[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(t,r.key,r)}}function n(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}var r=this&&this.__importStar||function(t){if(t&&t.__esModule)return t;var e={};if(null!=t)for(var n in t)Object.hasOwnProperty.call(t,n)&&(e[n]=t[n]);return e.default=t,e};Object.defineProperty(exports,"__esModule",{value:!0});var i=r(require("d3")),a=require("./GraphNode"),o=require("./GraphData"),s=function(){function e(){var n=this;t(this,e),this.ticked=function(){var t,e;null===(t=n.node)||void 0===t||t.call(n.updateNode),null===(e=n.link)||void 0===e||e.call(n.updateLink)},this.updateNode=function(t){t.attr("transform",function(t){return"translate("+n.fixna(t.x)+","+n.fixna(t.y)+")"})},this.updateLink=function(t){t.attr("x1",function(t){return n.fixna(t.source.x)}).attr("y1",function(t){return n.fixna(t.source.y)}).attr("x2",function(t){return n.fixna(t.target.x)}).attr("y2",function(t){return n.fixna(t.target.y)})};var r=i.select("#renderContainer").attr("width",400).attr("height",400);r.style("background-color","lightblue"),this.container=r.append("g"),this.graphData=new o.GraphData(this),this.simulation=this.createGraphLayout(this.graphData,400,400),this.link=this.container.append("g").selectAll("link"),this.node=this.container.append("g").selectAll("node"),r.call(i.zoom().scaleExtent([.1,4]).on("zoom",function(){return n.container.attr("transform",i.event.transform)})),this.renderNodes(),this.renderLinks()}return n(e,[{key:"addNewNode",value:function(t,e){var n=new a.GraphNode(this.graphData,t,e);return this.graphData.pushNode(n),this.renderNodes(),this.restartSimulation(),n}},{key:"getNode",value:function(t){if(t)return this.graphData.nodesMap[t]}},{key:"createGraphLayout",value:function(t,e,n){return i.forceSimulation(t.getNodes()).force("charge",i.forceManyBody().strength(-3e3)).force("center",i.forceCenter(e/2,n/2)).force("x",i.forceX(e/2).strength(1)).force("y",i.forceY(n/2).strength(1)).force("link",i.forceLink(t.getLinks()).id(function(t){return t.id}).distance(100).strength(1)).on("tick",this.ticked)}},{key:"renderLinks",value:function(){this.link&&(this.link=this.link.data(this.graphData.getLinks(),function(t){return t.id}),this.link.exit().remove(),this.link=this.link.enter().append("line").attr("stroke","#000").attr("stroke-width",1.5).merge(this.link))}},{key:"renderNodes",value:function(){if(this.node){this.node=this.node.data(this.graphData.getNodes(),function(t){return t.id}),this.node.exit().remove();var t=this.node.enter().append("g");t.append("ellipse").attr("rx",40).attr("ry",20).attr("fill","#888"),t.append("text").attr("text-anchor","middle").attr("alignment-baseline","central").text(function(t){return t.getText()}),this.node=this.node.merge(t),this.node.selectAll("text").text(function(t){return t.getText()})}}},{key:"restartSimulation",value:function(){this.simulation.nodes(this.graphData.getNodes()),this.simulation.force("link").links(this.graphData.getLinks()),this.simulation.alpha(.3).restart()}},{key:"fixna",value:function(t){return void 0!==t&&isFinite(t)?t:0}}]),e}();exports.MindmapView=s;
},{"d3":"UzF0","./GraphNode":"moJA","./GraphData":"dL8o"}],"YDg4":[function(require,module,exports) {
"use strict";function t(e){return(t="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t})(e)}function e(t){return function(){var e,r=i(t);if(o()){var u=i(this).constructor;e=Reflect.construct(r,arguments,u)}else e=r.apply(this,arguments);return n(this,e)}}function n(e,n){return!n||"object"!==t(n)&&"function"!=typeof n?r(e):n}function r(t){if(void 0===t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return t}function o(){if("undefined"==typeof Reflect||!Reflect.construct)return!1;if(Reflect.construct.sham)return!1;if("function"==typeof Proxy)return!0;try{return Date.prototype.toString.call(Reflect.construct(Date,[],function(){})),!0}catch(t){return!1}}function i(t){return(i=Object.setPrototypeOf?Object.getPrototypeOf:function(t){return t.__proto__||Object.getPrototypeOf(t)})(t)}function u(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function");t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,writable:!0,configurable:!0}}),e&&c(t,e)}function c(t,e){return(c=Object.setPrototypeOf||function(t,e){return t.__proto__=e,t})(t,e)}function f(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var a=function t(e){f(this,t),this.name=e};exports.ParseEvent=a;var s=function(t){u(r,a);var n=e(r);function r(t,e){var o;return f(this,r),(o=n.call(this,t)).name=t,o.id=e,o}return r}();exports.NodeEvent=s,s.NAME="node";var l=function(t){u(r,s);var n=e(r);function r(t,e,o){var i;return f(this,r),(i=n.call(this,r.NAME,t)).id=t,i.parentId=e,i.text=o,i}return r}();exports.AddNodeEvent=l,l.NAME="node.add";var p=function(t){u(r,s);var n=e(r);function r(t,e,o){var i;return f(this,r),(i=n.call(this,r.NAME,t)).id=t,i.parentId=e,i.text=o,i}return r}();exports.EditNodeEvent=p,p.NAME="node.edit";var y=function(t){u(r,s);var n=e(r);function r(t){var e;return f(this,r),(e=n.call(this,r.NAME,t)).id=t,e}return r}();exports.DeleteNodeEvent=y,y.NAME="node.delete";
},{}],"i9Ww":[function(require,module,exports) {
"use strict";function e(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}function n(e,n){for(var t=0;t<n.length;t++){var i=n[t];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}function t(e,t,i){return t&&n(e.prototype,t),i&&n(e,i),e}Object.defineProperty(exports,"__esModule",{value:!0});var i=require("./graph/MindmapView"),d=require("../core/events/EventTypes"),r=function(){function n(t){var i=this;e(this,n),this.handlers={addNodeEvent:function(e){console.log("Received event in handler: ",e);var n=void 0!==e.parentId?""+e.parentId:void 0;i.mindmap.addNewNode(""+e.id,e.text).changeParent(n)},editNodeEvent:function(e){console.log("Received event in handler: ",e);var n=i.mindmap.getNode(""+e.id);n?(n.changeParent(void 0!==e.parentId?""+e.parentId:void 0),n.changeText(e.text,0)):console.error("No Node with id "+e.id)},deleteNodeEvent:function(e){console.log("Received event in handler: ",e);var n=i.mindmap.getNode(""+e.id);n?n.remove():console.error("No Node with id "+e.id)}},this.eventHandler=t,this.initEventHandlers(),this.mindmap=this.initMindmap()}return t(n,[{key:"initEventHandlers",value:function(){this.eventHandler.registerHandler(d.AddNodeEvent.NAME,this.handlers.addNodeEvent),this.eventHandler.registerHandler(d.EditNodeEvent.NAME,this.handlers.editNodeEvent),this.eventHandler.registerHandler(d.DeleteNodeEvent.NAME,this.handlers.deleteNodeEvent)}},{key:"initMindmap",value:function(){return new i.MindmapView}}]),n}();exports.EventRenderer=r;
},{"./graph/MindmapView":"hS4r","../core/events/EventTypes":"YDg4"}],"mIhj":[function(require,module,exports) {
"use strict";function r(r,e){if(!(r instanceof e))throw new TypeError("Cannot call a class as a function")}function e(r,e){for(var t=0;t<e.length;t++){var n=e[t];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(r,n.key,n)}}function t(r,t,n){return t&&e(r.prototype,t),n&&e(r,n),r}var n;Object.defineProperty(exports,"__esModule",{value:!0}),function(r){r[r.ERROR=0]="ERROR",r[r.WARN=1]="WARN",r[r.INFO=2]="INFO",r[r.VERBOSE=3]="VERBOSE",r[r.DEBUG=4]="DEBUG",r[r.TRACE=5]="TRACE"}(n=exports.Level||(exports.Level={}));var a=function(){function e(t){r(this,e),this.formatters={i:function(r){return r},s:function(r){return r},j:function(r){return JSON.stringify(r)}},this.label=t}return t(e,[{key:"logWithParams",value:function(r,e){console.log("".concat(this.label," ").concat(n[r]),this.formatLog(e))}},{key:"formatLog",value:function(r){var e=this;if(!r||!r.length)return"";if("string"==typeof r[0]){if(1===r.length)return r[0];var t=0;return r[0].replace(/%([a-zA-Z%])/g,function(n,a){if("%%"===n)return n;if(++t>=r.length)return n;var o=e.formatters[a];return"function"==typeof o&&(n=o.call(e,r[t])),n})}return r}},{key:"error",value:function(){for(var r=arguments.length,e=new Array(r),t=0;t<r;t++)e[t]=arguments[t];this.logWithParams(n.ERROR,e)}},{key:"warn",value:function(){for(var r=arguments.length,e=new Array(r),t=0;t<r;t++)e[t]=arguments[t];this.logWithParams(n.WARN,e)}},{key:"info",value:function(){for(var r=arguments.length,e=new Array(r),t=0;t<r;t++)e[t]=arguments[t];this.logWithParams(n.INFO,e)}},{key:"verbose",value:function(){for(var r=arguments.length,e=new Array(r),t=0;t<r;t++)e[t]=arguments[t];this.logWithParams(n.VERBOSE,e)}},{key:"debug",value:function(){for(var r=arguments.length,e=new Array(r),t=0;t<r;t++)e[t]=arguments[t];this.logWithParams(n.DEBUG,e)}},{key:"trace",value:function(){for(var r=arguments.length,e=new Array(r),t=0;t<r;t++)e[t]=arguments[t];this.logWithParams(n.TRACE,e)}}]),e}();exports.Logger=a;
},{}],"WOs9":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=require("./core/logger/JustLogger"),r=function(r){return new e.Logger(r)};exports.coreLogger=function(e){return r("core."+e)},exports.rendererLogger=function(e){return r("renderer."+e)},exports.editorLogger=function(e){return r("editor."+e)};
},{"./core/logger/JustLogger":"mIhj"}],"Ie1b":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.LEXEM_EMPTY_LINE="empty",exports.LEXEM_INDENT="indent",exports.LEXEM_NODE_TEXT="text",exports.LEXEM_MULTILINE_INDICATOR="multilineIndicator",exports.LEXEM_PROPERTY_LIST_START="propertyListStart",exports.LEXEM_PROPERTY_LIST_END="propertyListEnd",exports.LEXEM_PROPERTY_SEPARATOR="propertySeparator",exports.LEXEM_PROPERTY_ASSIGN="propertyAssign",exports.LEXEM_PROPERTY_NAME="propertyName",exports.LEXEM_PROPERTY_VALUE="propertyValue";
},{}],"BNrN":[function(require,module,exports) {
"use strict";function e(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function t(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function n(e,n,r){return n&&t(e.prototype,n),r&&t(e,r),e}Object.defineProperty(exports,"__esModule",{value:!0});var r=require("./LexemType");exports.REGEX_LINE=/^(\s*)(.*)/,exports.REGEX_NODE=/(\+?)(\s*)(.*)/;var s=function(){function t(){e(this,t)}return n(t,[{key:"tokenizeLine",value:function(e){var t=0,n={lexems:[],errors:[]};if(/^(\s*)$/.test(e))return n.lexems.push({type:r.LEXEM_EMPTY_LINE,start:t,end:e.length,content:e}),n;var s=e.split(exports.REGEX_LINE),l=s[1];l.length&&(n.lexems.push({type:r.LEXEM_INDENT,start:t,end:t+l.length,content:l}),t=l.length);var o=s[2];if("("===o.charAt(0));else if("#"===o.charAt(0));else{var a=o.split(exports.REGEX_NODE),E=a[1];E.length&&(n.lexems.push({type:r.LEXEM_MULTILINE_INDICATOR,start:t,end:t+E.length,content:E}),t+=E.length),t+=a[2].length;var i=a[3];i.length&&(n.lexems.push({type:r.LEXEM_NODE_TEXT,start:t,end:t+i.length,content:i}),t+=i.length)}return n}}]),t}();exports.MindNotesLexer=s;
},{"./LexemType":"Ie1b"}],"Jx33":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=require("../../logger");exports.parserLogger=function(r){return e.coreLogger("parser."+r)};
},{"../../logger":"WOs9"}],"Kw98":[function(require,module,exports) {
"use strict";function e(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}function n(e,n){for(var t=0;t<n.length;t++){var i=n[t];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}function t(e,t,i){return t&&n(e.prototype,t),i&&n(e,i),e}Object.defineProperty(exports,"__esModule",{value:!0});var i=require("./logger.parser"),r=require("../events/EventTypes"),s=i.parserLogger("line"),d=function(){function n(t){e(this,n),this.started=!1,this.tree=t,this.parsedLine=this.createNewParsedLine(-1,"")}return t(n,[{key:"start",value:function(e,n){this.started=!0,this.parsedLine={line:e,indentation:0,content:n,events:[],errors:[]}}},{key:"deleteLine",value:function(){var e=this.tree.nodesAtLine[this.parsedLine.line];return s.debug('Deleting line from node "%s"',null==e?void 0:e.headText),e&&(this.getPreviousNode()!==e?(s.debug("Removing node"),this.deleteNode(e)):s.warn("Removing stuff from node body is not supported")),this.tree.nodesAtLine.splice(this.parsedLine.line,1),this.parsedLine}},{key:"insertLine",value:function(){return s.debug("Inserting line at %i",this.parsedLine.line),this.tree.insertLine(this.parsedLine.line),this.parsedLine}},{key:"finish",value:function(){if(!this.started)throw this.handleNotStarted();return this.started=!1,this.tree.applyLine(this.parsedLine.line),this.parsedLine}},{key:"pushError",value:function(e,n){if(!this.parsedLine)throw this.handleNotStarted();s.warn("Parse Error (%s) on line %i (%s): %s",e,this.parsedLine.line,this.parsedLine.content,n),this.parsedLine.errors.push({line:this.parsedLine.line,content:this.parsedLine.content,name:e,text:n})}},{key:"pushEvent",value:function(e){if(!this.parsedLine)throw this.handleNotStarted();s.debug("New Event (%s) on line %i (%s): %s",e.name,this.parsedLine.line,this.parsedLine.content,JSON.stringify(e)),this.parsedLine.events.push(e)}},{key:"getExistingNode",value:function(){return this.parsedLine.line<this.tree.nodesAtLine.length?this.tree.nodesAtLine[this.parsedLine.line]:void 0}},{key:"getPreviousNode",value:function(){if(!(this.parsedLine.line<1))return this.tree.getNodeOfLine(this.parsedLine.line-1)}},{key:"getPrevIndent",value:function(){return this.tree.prevIndent(this.parsedLine.line)}},{key:"editNode",value:function(e,n){var t;e.headText=n;var i=new r.EditNodeEvent(e.id,null===(t=e.parent)||void 0===t?void 0:t.id,n);this.parsedLine.events.push(i)}},{key:"deleteNode",value:function(e){s.debug('Removing node "%s"',e.headText);var n=this.getPreviousNode(),t=this.parsedLine.line;do{this.tree.nodesAtLine[t]=n,t++}while(t<this.tree.nodesAtLine.length&&this.tree.nodesAtLine[t]===e);var i=new r.DeleteNodeEvent(e.id);this.parsedLine.events.push(i)}},{key:"addNewNode",value:function(e){var n,t;s.verbose("Adding new node with text %s",e);var i=this.parsedLine,d=this.getExistingNode();if(s.verbose("Number of tree lines (%i) with cur line (%i)",this.tree.nodesAtLine.length,this.parsedLine.line),d)if(s.verbose("Node at line already exists with text %s",e),d.headText&&d.headText===e);else{d.headText=e;var o=new r.EditNodeEvent(d.id,null===(n=d.parent)||void 0===n?void 0:n.id,e);i.events.push(o)}else{var a=this.tree.addNewParserNode(i.line,i.indentation,e),h=new r.AddNodeEvent(a.id,null===(t=a.parent)||void 0===t?void 0:t.id,e);i.events.push(h)}}},{key:"changeNodeIndentation",value:function(e,n){var t,i;if(s.debug("Node indentation update"),e.indentation<n){if(e.predecessor){if(e.predecessor.indentation!==e.indentation)return void this.pushError("NoPrecedingSibling","Cannot update indentation.");s.debug("Moving to new node."),e.parent=e.predecessor;var d=new r.EditNodeEvent(e.id,null===(t=e.parent)||void 0===t?void 0:t.id,e.headText);this.parsedLine.events.push(d)}else e.parent=void 0;e.parent=e.predecessor}else if(e.indentation>n){if(e.parent){if(e.parent.indentation!==e.indentation)return void this.pushError("NoPrecedingSibling","Cannot update indentation.");s.debug("Moving one parent up"),e.parent=e.predecessor}else e.parent=void 0;var o=new r.EditNodeEvent(e.id,null===(i=e.parent)||void 0===i?void 0:i.id,e.headText);this.parsedLine.events.push(o)}}},{key:"createNewParsedLine",value:function(e,n){return{line:e,indentation:0,content:n,events:[],errors:[]}}},{key:"handleNotStarted",value:function(){throw new Error("start() has to be called in order to initialize a line.")}},{key:"indentation",set:function(e){this.parsedLine.indentation=e},get:function(){return this.parsedLine.indentation}},{key:"lineContent",get:function(){return this.parsedLine.content}},{key:"line",get:function(){return this.parsedLine.line}}]),n}();exports.LineParser=d;
},{"./logger.parser":"Jx33","../events/EventTypes":"YDg4"}],"NOqv":[function(require,module,exports) {
"use strict";function e(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function t(e,t){for(var n=0;n<t.length;n++){var i=t[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}function n(e,n,i){return n&&t(e.prototype,n),i&&t(e,i),e}Object.defineProperty(exports,"__esModule",{value:!0});var i=require("../lexer/LexemType"),o=require("../logger.parser"),a=require("../../events/EventTypes"),d=o.parserLogger("node"),r=function(){function t(n,i,o,a){e(this,t),this.id=n,this.tree=i,this.indentation=o,this.headText=a}return n(t,[{key:"handleLineChange",value:function(e,t){this!==t.getPreviousNode()?this.handleHeadChange(e,t):this.handleBodyChange(e,t)}},{key:"handleHeadChange",value:function(e,t){var n=e.shift(),o=t.indentation;if((null==n?void 0:n.type)===i.LEXEM_EMPTY_LINE)t.deleteNode(this);else if(this.indentation!==o&&t.changeNodeIndentation(this,o),(null==n?void 0:n.type)===i.LEXEM_NODE_TEXT){var a=n.content;d.verbose("Node at line already exists with text %s",a),this.headText&&this.headText!==a&&t.editNode(this,a)}else t.pushError("NodeHeadTextChange","Node has to start with text.")}},{key:"handleBodyChange",value:function(e,t){var n,o=e.shift();if((null==o?void 0:o.type)===i.LEXEM_EMPTY_LINE)d.debug("Skipped empty line");else if((null==o?void 0:o.type)===i.LEXEM_NODE_TEXT){d.debug("Adding new node to existing node");var r=this.tree.addNewParserNode(t.line,t.indentation,o.content),s=new a.AddNodeEvent(r.id,null===(n=r.parent)||void 0===n?void 0:n.id,o.content);t.pushEvent(s)}else d.warn("Unhandled token: ",null==o?void 0:o.type,null==o?void 0:o.content)}}]),t}();exports.ParserNode=r;
},{"../lexer/LexemType":"Ie1b","../logger.parser":"Jx33","../../events/EventTypes":"YDg4"}],"t7lw":[function(require,module,exports) {
"use strict";function e(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}function n(e,n){for(var t=0;t<n.length;t++){var i=n[t];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}function t(e,t,i){return t&&n(e.prototype,t),i&&n(e,i),e}Object.defineProperty(exports,"__esModule",{value:!0});var i=require("./ParserNode"),o=require("../logger.parser"),s=o.parserLogger("tree"),r=function(){function n(){e(this,n),this.lastId=n.INITIAL_NODE_ID,this._nodes={},this._nodesAtLine=[]}return t(n,[{key:"getNodeOfLine",value:function(e){if(!(e<0||this._nodesAtLine.length<e))return this._nodesAtLine[e]}},{key:"addNewParserNode",value:function(e,n,t){var o=this.generateNodeId();s.debug("Adding new parse node to line %i (%s)",e,t);var r=this.getNodeOfLine(e),d=this.getNodeOfLine(e-1),a=new i.ParserNode(o,this,n,t);if(r&&r!==d)throw s.error("Existing (%i, %s) equals previous (%i, %s)",null==r?void 0:r.id,null==r?void 0:r.headText,null==d?void 0:d.id,null==d?void 0:d.headText),new Error("Cannot add node to a line that already contains a node head.");if(d&&d.indentation!==n)if(d.indentation<n){a.parent=d;var u=this.getNodeOfLine(e+1);u&&(u.indentation===a.indentation?(u.predecessor=a,a.successor=u):u.indentation>a.indentation&&(u.parent=a)),s.debug("Added as child of node %i (%s)",a.parent.id,a.parent.headText)}else{for(var c=d;c&&c.indentation>a.indentation;)c=c.parent;if(!c)throw new Error("Found no predecessor but decreased indentation. Is there space on the root node?");if(s.debug("Found predecessor %i (%s)",c.id,c.headText),c.indentation!==n)throw s.warn("Moved up node but sibling has not exactly the same indentation.Predecessor has %i, newNode has %i",c.indentation,a.indentation),new Error("Indentation of parent node is not matching.");c.successor&&(c.successor.predecessor=a),a.parent=c.parent,a.successor=c.successor,c.successor=a,a.predecessor=c;var l=this.getNodeOfLine(e+1);l&&l.indentation>a.indentation&&(d.successor=void 0,l.predecessor=void 0,l.parent=a),s.debug("Added as parent")}else a.successor=null==d?void 0:d.successor,d&&(d.successor&&(d.successor.predecessor=a),d.successor=a),a.predecessor=d,a.parent=null==d?void 0:d.parent,s.debug("Added as sibling");if(this._nodes[o])throw new Error("Duplicated Node id: "+o);return this._nodes[o]=a,this._nodesAtLine[e]=a,a}},{key:"insertLine",value:function(e){s.debug("Inserting line at ".concat(e)),this._nodesAtLine.splice(e,0,void 0),this.applyLine(e)}},{key:"prevIndent",value:function(e){if(--e<0||this._nodesAtLine.length<e)return 0;var n=this._nodesAtLine[e];return n?n.indentation:0}},{key:"generateNodeId",value:function(){return this.lastId++}},{key:"getNodeById",value:function(e){return this._nodes[e]}},{key:"applyLine",value:function(e){var n,t,i=this.getNodeOfLine(e);this._nodesAtLine[e]=void 0===i?this.getNodeOfLine(e-1):i,s.debug("Applied node %i (%s) to line %i",null===(n=this._nodesAtLine[e])||void 0===n?void 0:n.id,null===(t=this._nodesAtLine[e])||void 0===t?void 0:t.headText,e)}},{key:"nodesAtLine",get:function(){return this._nodesAtLine}}]),n}();exports.ParserTree=r,r.INITIAL_NODE_ID=1;
},{"./ParserNode":"NOqv","../logger.parser":"Jx33"}],"KKpR":[function(require,module,exports) {
"use strict";function e(e,i){if(!(e instanceof i))throw new TypeError("Cannot call a class as a function")}function i(e,i){for(var r=0;r<i.length;r++){var t=i[r];t.enumerable=t.enumerable||!1,t.configurable=!0,"value"in t&&(t.writable=!0),Object.defineProperty(e,t.key,t)}}function r(e,r,t){return r&&i(e.prototype,r),t&&i(e,t),e}Object.defineProperty(exports,"__esModule",{value:!0});var t=require("./lexer/LexemType"),n=require("./lexer/MindNotesLexer"),s=require("./LineParser"),a=require("./tree/ParserTree"),o=require("./logger.parser"),l=o.parserLogger("parser"),h=function(){function i(){e(this,i),this.lexer=new n.MindNotesLexer,this.tree=new a.ParserTree,this.textLines=[],this.lineParser=new s.LineParser(this.tree)}return r(i,[{key:"parse",value:function(e){var i=this,r={tree:this.tree,parsedLines:[],events:[],errors:[]};return this.refreshText(e),l.verbose("Parsing %i lines",this.textLines.length),this.textLines.forEach(function(e,t){i.lineParser.start(t,e),i.parseLine(i.lineParser);var n=i.lineParser.finish();l.verbose("Got line result: ",n),r.errors=r.errors.concat(n.errors),r.events=r.events.concat(n.events)}),r}},{key:"edit",value:function(e,i,r,t,n){var s={tree:this.tree,parsedLines:[],events:[],errors:[]};l.verbose('Editing lines, start=(%i, %i), end=(%i, %i), newText="%s"',e,i,r,t,n.replace(/\r?\n/g,"\\n"));var a=n.split(/\r?\n/);l.debug("Changing %i lines.",a.length),l.debug("Split:",JSON.stringify(a));var o=r-e+1;l.debug("Change affects %i existing lines.",o);for(var h=-1,u=0;u<a.length&&h<r;u++){var d=a[u];l.debug('New line "%s"',d),h=u+e,l.debug("exLineIndex %i",h);var g=void 0,v=void 0;l.debug("Existing line %s",this.textLines[h]),h===e&&(g=i),h===r&&(v=t),l.debug("curStartCar=%i, curEndChar=%i",g,v),this.textLines[h]=this.replaceString(this.textLines[h]||"",g,v,d),l.debug("Reparsing line %i (%s)",u,this.textLines[h]),this.lineParser.start(h,this.textLines[h]),this.parseLine(this.lineParser);var c=this.lineParser.finish();this.combineParserResult(s,c)}l.debug("New lines: ",JSON.stringify(this.textLines)),l.debug("index=%i, affectedLines=%i",u,o);var f=0;if(a.length<o){f=this.textLines.splice(u+e,o-u).length,l.debug("Removing %i lines that were squashed by the change",f);for(var L=0;L<f;L++){l.debug("Deleting internal line %i",u+e+L),this.lineParser.start(u+e,"");var b=this.lineParser.deleteLine();this.lineParser.finish(),this.combineParserResult(s,b)}}if(a.length>o){l.verbose("Adding remaining lines");for(var p=u;p<a.length;p++){this.textLines.splice(e+u+p-1,0,a[p]),this.lineParser.start(e+u+p-1,a[p]);var x=this.lineParser.insertLine();this.parseLine(this.lineParser),this.lineParser.finish(),this.combineParserResult(s,x)}}return l.verbose("Lines after edit: %s",JSON.stringify(this.textLines)),s}},{key:"combineParserResult",value:function(e,i){l.debug("Got line result: ",i),e.errors=e.errors.concat(i.errors),e.events=e.events.concat(i.events)}},{key:"replaceString",value:function(e,i,r,t){return void 0===i&&void 0===r?t:void 0===r?e.substring(0,i)+t:void 0===i?t+e.substring(r):e.substring(0,i)+t+e.substring(r)}},{key:"parseLine",value:function(e){var i=e.lineContent,r=this.lexer.tokenizeLine(i).lexems;if(l.debug("Got tokens for line: ",r),r.length){var n,s=0;(null==(n=r[0])?void 0:n.type)===t.LEXEM_INDENT&&(s=n.content.length,l.debug("indentation=%i",s),r.shift(),n=r[0]),e.indentation=s;var a=e.getPreviousNode(),o=e.getExistingNode();a||o||(null==n?void 0:n.type)===t.LEXEM_EMPTY_LINE?o?o.handleLineChange(r,e):a&&a.handleLineChange(r,e):(l.debug("This is the root node - no previous node"),(null==n?void 0:n.type)===t.LEXEM_NODE_TEXT?e.addNewNode(n.content):e.pushError("RootNode","Root node has to start with text."))}else e.pushError("UnprocessableLine","No tokens identified for line!")}},{key:"refreshText",value:function(e){this.textLines=e.split(/\r?\n/)}}]),i}();exports.MindNotesParser=h;
},{"./lexer/LexemType":"Ie1b","./lexer/MindNotesLexer":"BNrN","./LineParser":"Kw98","./tree/ParserTree":"t7lw","./logger.parser":"Jx33"}],"FKBH":[function(require,module,exports) {
"use strict";function e(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function t(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function n(e,n,r){return n&&t(e.prototype,n),r&&t(e,r),e}Object.defineProperty(exports,"__esModule",{value:!0});var r=require("../logger"),i=require("../core/parser/MindNotesParser"),o=r.editorLogger("editor");document.addEventListener("selectionchange",function(){console.log("on selection change")});var a=function(){function t(n){e(this,t),this.parser=new i.MindNotesParser,this.events=n,this.textArea=document.getElementById("textEditor"),this.init()}return n(t,[{key:"init",value:function(){var e=this,t=this.textArea;t.addEventListener("change",function(e){o.trace("selection change"),console.log(e),o.debug("selectionStart %i, selectionEnd %i",t.selectionStart,t.selectionEnd)},!1),t.addEventListener("input",function(n){o.trace(n),o.debug("target %s, selectionStart %i, selectionEnd %i , rows %i",n.data,n.target.selectionStart,n.target.selectionEnd,n.target.rows),e.parser.parse(t.value).events.forEach(function(t){e.events.emit(t)})},!1)}}]),t}();exports.TextEditor=a;
